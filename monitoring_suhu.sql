...
insert  into `edukasi`(`id`,`judul`,`gambar`,`isi`,`status`,`created_by`,`created_at`,`updated_at`) values 
(1,'INI PACAR VANTIIIIIII','download (7).jpg','gantengkan???','draft',NULL,'2026-05-31 21:14:58','2026-05-31 22:35:45'),
(6,'Si Gadis Desa Yang Cantik Jelita','PIXECT-20250324180508.jpg','Lahir pada tahun 2007, membuat si gadis desa ini di bully teman-temannya. Katanya \"bocil\", \"anak kecil\", namun itu tak membuat si gadis desa ini menyerah. Dia terus berjuang dan pada akhirnya ia menjadi INCESS','draft',NULL,'2026-05-31 21:50:43','2026-06-02 18:37:20');
...
(6,'vanti imut','van@gmail.com','$2y$10$8lEHJNxKFypCQj5PkVQIlO5qb2/fnK4ASNgn.X2mAp5nEbn1sfi76','user','2026-05-29 13:16:30'),
(7,'cia','cia@gmail.com','$2y$10$g4VLY4sHJOJ5HH62yYelTeGf.Pbqh.iFAkn1DM/5JkTBJj8jrcu3S','user','2026-06-02 13:20:40');
